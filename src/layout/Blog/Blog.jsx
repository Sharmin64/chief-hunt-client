...
const Blog = () => {
  ...
  return (
    <div className="text-center container mx-auto bg-[#e8f3ff] mt-36">
      <h1 className="text-6xl text-yellow-900">Blog Page</h1>
      <div ref={ref}>
        <h1 className="text-center text-3xl font-bold text-[#4951d2] font-serif">
          Answer to Question blog
        </h1>
        ...
        <div className="card content-center border-spacing-2 rounded p-5">
          ...
          <p className="break-words">
            propTypes is used for props validation. If some of the props are not
        ...
        <div className="card content-center">
          ...
          <p className="break-words">
            ...
            is detailed as A platform built on Chromes JavaScript runtime for
            easily building fast, scalable network application. besides node js
            and JavaScript are the key factors that is why developers consider
            ExpressJS
          </p>
        </div>
        <div className="card content-center">
          <h2 className="text-3xl text-fuchsia-950">
          ...
          <p className="break-words">
            ...
            again and again while rendering the whole code.that is the reason I
      ...
      <Pdf targetRef={ref} filename="code-example.pdf">
        {({toPdf}) => (
          <button
            className=" btn rounded-xl text-3xl py-3 px-6 border-x-2 bg-zinc-600 mt-8"
            onClick={toPdf}
          >
            Download Pdf
          </button>
