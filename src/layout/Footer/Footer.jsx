  ...
  return (
    ...
    <div className="footer-header grid grid-cols-2 lg:grid-cols-5 gap-8 text-gray-50 mb-5 mt-10">
        <div>
          ...
          <li> <FaFacebookF className='text-sky-500 text-5xl'></FaFacebookF></li>
           <li> <FaFacebookMessenger className='text-violet-500 text-5xl'></FaFacebookMessenger></li>
          <li> <FcGoogle className='text-5xl'></FcGoogle></li>
          <li> <FaTwitter className='text-blue-400 text-5xl'></FaTwitter></li>
    ...
    <div className=" text-center mt-12 mb-32 mx-auto">
        <div className=''>
            <p className='font-normal text-xl text-[#fffaf0] mb-5'> © Copyright Protected Chef Recipe</p>
        </div>
